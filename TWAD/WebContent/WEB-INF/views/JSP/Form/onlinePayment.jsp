...
$(document).ready(function(){
	...
	function validateForm(){
	  ...
	  /*   var paymentDDNoId = $('#paymentDDNoId');
	    ...
	    var inputVal = new Array(paymentTypeId,appId,paymentDDAmountId);
...
<table id="statusHeader" align="center" class="table-bordered table table-striped display" style="width: 970px;">
	...
	<form id="formId" action="saveOnlinePaymentsDetails.do"  method="POST" style="width:970px;margin-left: 195px;">
...
<select id="paymentTypeId" name="paymentType">
 ...
 <tr><td class="tdPadding" width="50%"><b>Total Amount:</b></td><td>
